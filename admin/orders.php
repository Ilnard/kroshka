...
if (isset($_POST['delete-order'])) {
    ...
    query($sql);
    header("Location: http://$_SERVER[SERVER_NAME]/admin/orders.php");
}
?>
<!DOCTYPE html>
<html lang="ru">
                        ...
                        ?>
                                <div class="admin-product">
                                    <div class="media admin-product__media">
                                        <img src="../img/products/<?if ($product['id'] != 0) echo $product['picture']; else echo 'line.png' ?>" class="media__pict admin-product__pict">
                                    </div>
